 ...
 * 
 * <p>Esta Classe fornece operações matemáticos básicos como soma, subtração,
 * multiplicação e divisão, além de um método principal que seleciona a operação
 * desejada com base em um operador informado pelo usúario.</p>
...
public class Calculadora {
    ...
    /**
     * Divide dois números inteiros e impede divisões por zero
     * 
     * @param a primeiro operando
     * @param b segundo operando
